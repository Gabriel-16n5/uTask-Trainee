import {
  ...
  FraseDoDiaContent,
  FraseDoDiaTitle,
  FraseDoDiaTitleMobile,
  Icon,
  PageContainer,
} from '../style/HomePageCss';
    ...
    <PageContainer darkMode={darkMode}>
      ...
      <FraseDoDiaContainerMobile darkMode={darkMode} onClick={openModal}>
        <Icon darkMode={darkMode}>
          {darkMode ? (
            <img src={iconDark} alt="icon"></img>
          ) : (
            <img src={icon} alt="icon"></img>
          )}
        </Icon>
        <FraseDoDiaTitleMobile darkMode={darkMode}>
          Frase do dia
        </FraseDoDiaTitleMobile>
      </FraseDoDiaContainerMobile>
      <FraseDoDiaContainer darkMode={darkMode}>
        ...
        <FraseDoDiaContent>
          ...
          <FraseDoDia darkMode={darkMode}>
            Se você quer um pedacinho do paraíso, acredite em Deus. Mas se você
            quer conquistar o mundo, acredite em você porque Deus já te deu tudo
            o que você precisa para você vencer.
          </FraseDoDia>
        </FraseDoDiaContent>
      </FraseDoDiaContainer>
